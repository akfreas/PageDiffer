...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SiteHash'
        db.create_table(u'Differ_sitehash', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Differ.DiffedSite'])),
            ('md5hash', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('date', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'Differ', ['SiteHash'])


    def backwards(self, orm):
        # Deleting model 'SiteHash'
        db.delete_table(u'Differ_sitehash')
